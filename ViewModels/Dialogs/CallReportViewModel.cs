...
public class CallReportViewModel : ViewModelBase
{
    ...
    {
       "Оплатив у розмові", "Виставив рахунок", "Пішов думати", "Потрібно порадитися", "Не підходять умови", "Не цільовий", "Вже не актуально", "Неадекват", "Хоче оплатити в кінці роботи", "Вирішив виїжджати зі США", "Хоче зайнятися пізніше", "Домовились на передзвін", "Інший"
    };
